 ...
 */
abstract class ColosseumExecutor internal constructor(val commandString: String, val subCommandString: String = commandString, val plugin: JavaPlugin, val i18nManager: ColosseumI18nManager) : CommandExecutor, TabCompleter {
